<?php  
    ...
    if(isset($_GET['check'])){
        ...
        $gt->bindValue(1, 1); //status = 1 where active = $active
        ...
        <div class="row">
            <div class="register-item mb-5">
                ...
                <div class="input-register">
                    ...
                    <p style="color:green;"><?php if($successCheck){echo "
                        حساب کاربری شما با موفقیت فعال شد." ; }  ?></p>
                    <p style="color:red;"><?php if($errorCheck){echo "
                        کد فعالسازی اشتباه است. " ; }  ?></p>
                    <!-- پیغام های خطا و موفقیت -->

                    <form method="GET" action="">
                        <input type="number" name="check" style="display: block; width: 385px;" placeholder="کد فعالسازی را وارد کنید">
...
<footer>
 ...
 <?php  } ?>
   ...
   <!-- پیغام خطا اشتباه بودن کد فعالسازی -->
   <?php  if($errorCheck){  ?>
     
     <script>
             toastr.error('کد فعالسازی شما نادرست است.', 'پیغام خطا')
     </script>
